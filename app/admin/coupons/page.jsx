        ...
        <div className="text-slate-500 mb-40">
            ...
            <form onSubmit={(e) => toast.promise(handleAddCoupon(e), {loading: "Adding coupon..."})}
                ...
                <div className="flex gap-2 max-sm:flex-col mt-2">
                    ...
                    />
                    <input type="number" placeholder="Coupon Discount (%)" min={1} max={100}
                           className="w-full mt-2 p-2 border border-slate-200 outline-slate-400 rounded-md"
                           name="discount" value={newCoupon.discount} onChange={handleChange} required
                    />
                </div>
                <input type="text" placeholder="Coupon Description"
                       className="w-full mt-2 p-2 border border-slate-200 outline-slate-400 rounded-md"
                ...
                <label>
                    ...
                    <input type="date" placeholder="Coupon Expires At"
